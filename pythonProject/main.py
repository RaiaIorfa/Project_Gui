...
paye = Tk()
paye.title("CMP 114")
paye.configure(background="black")
math = maths()
physic = physics()
def clicked_maths():                            #WERE MATHS STARTS
    def Areaofsquare():
        ...
        paye3 = Toplevel(paye)
        paye3.configure(background="red")
    ...
    paye2 = Toplevel(paye)
    paye2.configure(background="blue")
...
def clicked_physics():
    ...
    paye7 = Toplevel(paye)
    paye7.configure(background="violet")
    bi = Label(paye7, text="WHAT FORMULA WOULD YOU LIKE TO USE ", bg="white", fg="black", font="algerian 50 bold").grid(row=0, column=0,padx=10,pady=10,ipadx=20,ipady=30)
    b1 = Button(paye7, text="speed", bg="white", fg="black", font="algerian 25 bold",command=Speed).grid(row=1, column=0,padx=5,pady=5,ipadx=8,ipady=12)
    bi = Button(paye7, text="force", bg="white", fg="black", font="algerian 25 bold",command=Force).grid(row=2, column=0,padx=5,pady=5,ipadx=8,ipady=12)
    bi = Button(paye7, text="workdone", bg="white", fg="black", font="algerian 25 bold",command=Workdone).grid(row=3, column=0,padx=5,pady=5,ipadx=8,ipady=12)
    bi = Button(paye7, text="potentialenergy", bg="white", fg="black", font="algerian 25 bold",command=Potentialenergy).grid(row=4, column=0,padx=5,pady=5,ipadx=8,ipady=12)
    bi = Button(paye7,text="kineticenergy", bg="white", fg="black", font="algerian 25 bold",command=Kineticenergy).grid(row=5, column=0,padx=5,pady=5,ipadx=8,ipady=12)


                    #were physics ends.......TAKE MOTE


Label(master = paye, text = "what subject would you like to use", bg="lavender", fg="teal", font="algerian  25 bold" ).grid(row=0, column=0,padx=10,pady=10,ipadx=20,ipady=30)
Label(master = paye, text = "", bg="lavender", font="none 30", ). grid(row=1, column=0)
mathbutton = Button(master=paye, text="MATHEMATICS", bg="Gold", fg="teal", font="arial 15 bold",command=clicked_maths).grid(row=4, column=0,padx=25,pady=30,ipadx=20,ipady=30)
Label(master = paye, text = "", bg="white", font="none 30", ). grid(row=3, column=0)
physicsbutton = Button(master=paye, text="PHYSICS", bg="violet", fg="teal", font="cursive 15",command=clicked_physics).grid(row=6, column=0,ipadx=20,ipady=30)
